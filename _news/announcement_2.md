...
<ul>
    <li>Working on human DNA sequence data, exploring disease associations</li>
    <li>Leveraging Slurm-based HPC for large-scale genomic data processing</li>
    <li>Analyzing genomic data via alignment, variant calling, and tools like BWA, GATK, and SAMtools</li>
    <li>Developing and optimizing bash scripts to automate workflows</li>
</ul>
